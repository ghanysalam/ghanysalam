...
- **Languages & Tools:** Python (pandas, numpy, scikit-learn, Matplotlib, Seaborn), SQL, Excel (Pivot, VLOOKUP), Tableau  
- **Machine Learning:** Regression, Classification, Clustering, Time Series  
- **NLP:** Preprocessing, BoW/TF-IDF, Sentiment (VADER), Topic Modeling, Text Classification  
- **Data Engineering:** Data Pipelines & ETL (Spark), automated reporting  
...
Open to full-time roles and freelance projects in analytics, risk/credit analytics, and data products.  
